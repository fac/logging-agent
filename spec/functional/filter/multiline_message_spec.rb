...
describe LogAgent::Filter::MultilineMessage do
  ...
  describe "in :start => /regexp/, :end => /regexp/ mode" do
    ...
    let(:start_line) { LogAgent::Event.new :message => "START OF BLOCK", :type => "railz", :uuid => 'foo', :tags => ['tag1', 'tag2'], :timestamp => test_timestamp, :source_type => "source_type", :source_path => "source_path", :op_id => "1234"}
